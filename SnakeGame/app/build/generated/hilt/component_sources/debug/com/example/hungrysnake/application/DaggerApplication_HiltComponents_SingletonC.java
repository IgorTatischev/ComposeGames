package com.example.hungrysnake.application;
...
import com.example.hungrysnake.presentation.main_activity.MainActivity;
import com.example.hungrysnake.presentation.screens.game.GameViewModel;
import com.example.hungrysnake.presentation.screens.game.GameViewModel_HiltModules_KeyModule_ProvideFactory;
import com.example.hungrysnake.presentation.screens.menu.MenuViewModel;
import com.example.hungrysnake.presentation.screens.menu.MenuViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends Application_HiltComponents.ActivityC {
    ...
    public Set<String> getViewModelKeys() {
      return SetBuilder.<String>newSetBuilder(2).add(GameViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(MenuViewModel_HiltModules_KeyModule_ProvideFactory.provide()).build();
    }
  ...
  private static final class ViewModelCImpl extends Application_HiltComponents.ViewModelC {
    ...
    private ScoreDataStore scoreDataStore() {
      return new ScoreDataStore(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));
    }
    ...
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return MapBuilder.<String, Provider<ViewModel>>newMapBuilder(2).put("com.example.hungrysnake.presentation.screens.game.GameViewModel", ((Provider) gameViewModelProvider)).put("com.example.hungrysnake.presentation.screens.menu.MenuViewModel", ((Provider) menuViewModelProvider)).build();
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.hungrysnake.presentation.screens.game.GameViewModel 
          return (T) new GameViewModel(viewModelCImpl.scoreDataStore());

          case 1: // com.example.hungrysnake.presentation.screens.menu.MenuViewModel 
          return (T) new MenuViewModel(viewModelCImpl.scoreDataStore());
